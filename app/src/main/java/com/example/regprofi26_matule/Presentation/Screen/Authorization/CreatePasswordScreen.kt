...
fun CreatePasswordScreen(
    ...
    Column(modifier = Modifier.fillMaxWidth().padding(horizontal = 20.dp, vertical = 103.dp),
        ...
        Row(modifier = Modifier.fillMaxWidth()) {
            ...
            SpacerW(16)
            Text("Создание пароля!", style = createMatuleTypography().title1Heavy, color = MatuleTheme.colors.black)

        }

        SpacerH(25)

        Text("Введите новый пароль", style = createMatuleTypography().textRegular,
